            ...
            <div className="two-col">
                <div className="card">
                    ...
                    <div style={{display: 'flex', flexDirection: 'column', gap: 18}}>
                        ...
                        <div className="formula-box">
                            <div>1cm 당
                                약 <strong>{stitchesPerCm.toFixed(2)}코</strong> · <strong>{rowsPerCm.toFixed(2)}단</strong>
                            </div>
                        </div>
                ...
                <div className="result">
                    ...
                    <div style={{
                        ...
                        <strong style={{color: 'var(--pink-700)'}}>Tip.</strong> 도안에 따라 가장자리 마감 코수를 1~2코 더하시면 좋아요. 무늬가
                        있는 경우 무늬 반복의 배수에 맞춰 반올림해주세요.
                    </div>
                </div>
            </div>
        </div>
